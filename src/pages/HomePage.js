...
// import servicesIcon1 from '../assets/icons/student-visa.svg';
// import servicesIcon2 from '../assets/icons/au-pair.svg';
// import servicesIcon3 from '../assets/icons/work-visa.svg';
// import servicesIcon4 from '../assets/icons/language.svg';
      ...
      <section className="about-section">
        <div className="about-image">
          <div className="image-container">
            <img src="/api/placeholder/600/400" alt="GERMANY Office" />
          </div>
        </div>
        ...
        <div className="testimonial-slider">
          <div className="testimonial">
            ...
            <div className="testimonial-content">
              ...
              <p>"GERMANY helped me secure admission to my dream university in Berlin. Their language courses and application guidance were invaluable."</p>
              <h4>Sujata Sharma</h4>
          ...
          <div className="testimonial">
            ...
            <div className="testimonial-content">
              ...
              <p>"The AU Pair program arranged by GERMANY was life-changing. I improved my German skills and experienced the culture firsthand."</p>
              <h4>Rohan Thapa</h4>
          ...
          <div className="testimonial">
            ...
            <div className="testimonial-content">
              ...
              <p>"Thanks to GERMANY's Ausbildung program guidance, I'm now training to be a nurse in Hamburg with a clear path to permanent residency."</p>
              <h4>Anisha Karki</h4>
